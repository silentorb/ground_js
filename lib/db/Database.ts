...
class Database implements mining.IQueryable {
  settings
  ...
  add_non_trellis_tables_to_database(tables:landscape.Table[], schema:landscape.Schema):Promise {
    ...
    var promises = MetaHub.map_to_array(non_trellises, (table:landscape.Table)=> this.add_table_to_database(table, schema));
