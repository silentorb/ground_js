...
(function (landscape) {
    ...
    })(landscape.Relationships || (landscape.Relationships = {}));
    var Relationships = landscape.Relationships;

    var Property = (function () {
        function Property(name, trellis) {
            this.name = null;
            this.parent = null;
            this.type = null;
            this.insert = null;
...
(function (landscape) {
    var Trellis = (function () {
        ...
        Trellis.prototype.add_property = function (name, source) {
            var property = new landscape.Property(name, this);
        ...
        Trellis.prototype.check_primary_key = function () {
            if (!this.properties[this.primary_key] && this.parent) {
                ...
                var new_property = new landscape.Property(this.primary_key, this);
...
(function (landscape) {
    ...
    landscape.Property_Type = Property_Type;
})(landscape || (landscape = {}));
...
(function (landscape) {
    var Schema = (function () {
        ...
        Schema.prototype.add_trellis = function (name, source, initialize_parent) {
            ...
            trellis = new landscape.Trellis(name, this);
            if (source)
                trellis.load_from_object(source);
        ...
        Schema.prototype.harden = function () {
...
(function (Ground) {
    ...
    var Core = (function (_super) {
        ...
        Core.prototype.export_schema = function () {
            return {
                objects: MetaHub.map_to_array(this.trellises, function (trellis) {
    ...
    var Query_Builder = (function () {
        ...
        Query_Builder.prototype.add_filter = function (path, value, operator) {
            ...
            if (path.indexOf('.') === -1) {
                ...
                if (!filter.property) {
                    throw new Ground.InputError('Invalid filter path.  landscape.Trellis ' + this.trellis.name + ' does not have a property named "' + path + '.');
                }
            }
    ...
    var Query_Runner = (function () {
        ...
        Query_Runner.prototype.process_reference_children = function (child, query, query_result) {
            ...
            for (name in query.subqueries) {
                ...
                promises.push(function () {
                    return property.type == 'list' ? Query_Runner.get_many_list(child, property, property.get_relationship(), query, query_result).then(function (result) {
        ...
        Query_Runner.prototype.normalize_union_fields = function (runner_parts) {
            ...
            for (var i = 0; i < field_list_length; ++i) {
                ...
                parts.dummy_references = field_names.filter(function (name) {
                    return alias_list[name] == undefined;
                });

                parts.fields = field_names.map(function (name) {
                    return alias_list[name] || 'NULL AS `' + name + '`';
                }).join(',\n');
            }
        };
                ...
                return _this.ground.db.query(render_result.sql).then(function (rows) {
                    ...
                    return _this.paging(render_result, result).then(function (result) {
                        return when.all(result.objects.map(function (row) {
                            return _this.process_row_step_one(row, _this.get_source(row), query_result, _this.get_parts(row, render_result));
                        })).then(function (rows) {
                            result.objects = rows;
