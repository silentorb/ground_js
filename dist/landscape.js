...
(function (landscape) {
    ...
    var Property = (function () {
        function Property(name, source, trellis) {
            ...
            this.access = 'auto'; // 'auto' or 'manual'
            this.allow_null = false;
            for (var i in source) {
        ...
        Property.prototype.get_field_override = function (create_if_missing) {
            ...
            if (!table) {
                if (!create_if_missing)
                    return null;
                table = landscape.Table.create_from_trellis(this.parent, this.parent.schema);
            }
        ...
        Property.prototype.get_field_type = function () {
            if (this.type == 'reference') {
                var other_trellis = this.other_trellis;
                var other_primary_property = other_trellis.properties[this.other_trellis.primary_key];
                if (other_primary_property)
                    return other_primary_property.get_field_type();
                return other_trellis.properties[other_trellis.primary_key].get_field_type();
            }
...
(function (landscape) {
    var Trellis = (function () {
        ...
        Trellis.prototype.add_property = function (name, source) {
            var property = new landscape.Property(name, source, this);
        ...
        Trellis.prototype.check_primary_key = function () {
            if (!this.properties[this.primary_key] && this.parent) {
                ...
                this.properties[this.primary_key] = new landscape.Property(this.primary_key, property.get_data(), this);
            }
        };
        ...
        Trellis.prototype.set_parent = function (parent) {
            ...
            if (parent.table && parent.table.primary_keys) {
                ...
                if (!this.table)
                    this.table = landscape.Table.create_from_trellis(this, this.schema);
...
(function (landscape) {
    ...
    })(landscape.Link_Field_Type || (landscape.Link_Field_Type = {}));
    var Link_Field_Type = landscape.Link_Field_Type;
    ...
    landscape.Link_Field = Link_Field;
    var Table = (function () {
        ...
        Table.prototype.create_link = function (property) {
            ...
            if (!other_table.trellis) {
                ...
                var other_field_name = link.field && link.field.other_field ? link.field.other_field : property.parent.name; // By default cross-table links are the name of the trellis they point to
